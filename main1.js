...
$("body").delegate("#product","click",function(event){
  ...
  $("body").delegate(".remove","click",function(event){
		...
		$.ajax({url: "action.php", method: "POST", data: {removeFromCart:1,removeId:pid}, success: function(data){
				$("#cart_msg").html(data);
				cart_checkout();
			}
		})
  ...
  $("body").delegate(".update","click",function(event){
		...
		$.ajax({url: "action.php", method: "POST", data: {updateProduct:1,updateId:pid,quantity:qty,price:price,total_amount:total}, success: function(data){
			$("#cart_msg").html(data);
			cart_checkout();	
			}
		})
 ...
 function page(){
     ...
     $.ajax({url: "action.php", method: "POST", data: {page:1}, success: function(data){
         $("#pageno").html(data);
           }
       })
    }
$("body").delegate("#page","click",function(){
	var pn = $(this).attr("page");
	 $.ajax({url: "action.php", method: "POST", data: {getproduct:1,setPage:1,pageNumber:pn}, success: function(data){
         $("#get_product").html(data);
           }
       })
